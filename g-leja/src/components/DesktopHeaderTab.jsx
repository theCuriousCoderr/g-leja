...
function DesktopHeaderTab({ idx, keyword, options }) {
  return (
    ...
    >
      ...
      <div className="hidden dropdown transition-all group-hover:block group-focus-within:block group-active:block absolute top-5 z-10 pt-16 left-2 min-w-28 bg-transparent ">
